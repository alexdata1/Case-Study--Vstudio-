...
I also debated removing any rows missing a $start_station_name or $end_station_name value, but given the large amount of trips missing these, I thought it best to include them so as not to dilute the available data too much.
